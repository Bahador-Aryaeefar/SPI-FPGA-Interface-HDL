...
vlog -work work -quiet ../tb/test_clock_generator.v 

###-cover bcesx
vsim -voptargs=+acc -quiet -L work +no_tchk_msg +notimingchecks work.test_clock_generator

# Set simulation options (optional)
# This controls how many waves are displayed and how the simulation progresses
add wave -radix binary -position top /test_clock_generator/*
